...
import {StyleSheet,AsyncStorage,ImageBackground,Dimensions} from 'react-native'
  ...
  render(){
    return(
      ...
      <Content>
        ...
        <Button onPress = {()=>this.handlerCamera()} style = {styles.ButtonImage} block><Text style = {{color : 'black'}}>+ Image</Text></Button>  
