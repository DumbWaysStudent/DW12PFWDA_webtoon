...
app.group("/api/v1",(router)=>{
    ...
    router.post('/user/:user_id/webtoon',authenticated,webtoonsController.addCreation)
    ...
    router.delete('/user/:user_id/webtoon/:webtoon_id/episode/:episode_id/image/:image_id',authenticated,webtoonsController.deleteDetailEpisode)
